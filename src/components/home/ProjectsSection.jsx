...
const ProjectsSection = () => {
  return (
    <section className="my-14 md:my-40 mx-7 md:mx-16">
      <div className="flex flex-col justify-center gap-3 w-full md:w-3/4 items-center mb-5 md:mb-14 max-w-screen-lg m-auto text-center">
        <h2 className="text-primary section-heading-h2">Our Projects</h2>
        <p className="text-sm md:text-2xl text-black font-karla font-normal mb-5">
      ...
      <div className="flex flex-col gap-8">
        <div className="flex flex-col md:flex-row gap-8 justify-between">
          ...
          <div className="w-full md:w-3/5 flex flex-col justify-center gap-5 md:gap-8 bg-gray p-5 md:p-10 border border-[#00000033] rounded-3xl">
            <h4 className="text-2xl md:text-[4rem] leading-none text-black font-archivo">
              Sync Time
            </h4>
            <p className="text-xl md:text-3xl font-light  leading-8 md:leading-10 text-black font-karla">
            ...
            <button className="flex justify-between items-center bg-primary-light px-5 md:px-8 py-2 md:py-4 text-primary rounded-full font-archivo text-xl md:text-3xl">
              VIEW MORE
        ...
        <div className="flex flex-col md:flex-row gap-8 justify-between group relative">
          <div className="w-full md:w-3/5 flex flex-col justify-center gap-5 md:gap-8 bg-gray p-5 md:p-10 border border-[#00000033] rounded-3xl transition-all duration-500 group-hover:bg-gradient-to-t group-hover:from-primary/20 group-hover:to-white">
            <h4 className="text-2xl md:text-[4rem] leading-none text-black font-archivo">
              Ultrasound MD
            </h4>
            <p className="text-xl md:text-3xl font-light leading-8 md:leading-10 text-black font-karla">
            ...
            <button className="flex justify-between items-center bg-primary-light px-5 md:px-8 py-2 md:py-4 text-primary rounded-full font-archivo text-xl md:text-3xl hover:bg-primary hover:text-white transition-all duration-300 ease-in-out">
              VIEW MORE
              <Image src={arrowRight} alt="arrow right" />
            </button>
          </div>
        ...
        <div className="flex justify-between rounded-full items-center bg-primary-light px-5 md:px-10 h-12 md:h-20 py-4 mt-5">
          <p className=" text-black font-archivo font-normal text-xs md:text-4xl">
